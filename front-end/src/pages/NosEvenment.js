...
const NosEvenment  = () => {
 ...
 <h1 style={{color:"#393738", fontFamily:"Poppins", fontWeight:"600",fontSize:"66px"}}>NOS ÉVÈNEMENTS</h1>
            </div>
                 </div>
     
    <div className="col-lg-6 col-sm-12 mb-4 ps-5 mt-5 d-flex justify-content-end align-items-center text-center mx-auto ps-5">
      <div className="card h-100" style={{ width:"500px", height:"450PX", borderRadius:"15px", overflow: "hidden"}}>
...
<img src={imgDesign} alt='design' className='img-design img-fluid'   style={{
   ...
   <h5 className='ps-2 pt-2 pe-2'style={{color:"#ffff",fontSize:"16px"}} >10:00 - 16:00</h5>
    ...
    <div className="col-lg-6 col-sm-12 mb-4 mt-5">
      <div className="card h-100" style={{ width:"500px", height:"450px", borderRadius:"15px", overflow: "hidden"}}>
        <div className='card-dev'>
<img src={imgDesign1} alt='design' className='img-design1 img-fluid'   style={{
   ...
   <h5 className='ps-2 pt-2 pe-2'style={{color:"#ffff",fontSize:"16px"}} >10:00 - 16:00</h5>
    ...
    <div className="col-lg-6 col-sm-12 mb-4 pt-5 ps-5 d-flex justify-content-end align-items-center text-center mx-auto ps-5">
      <div className="card h-100" style={{ width:"500px", height:"450PX", borderRadius:"15px", overflow: "hidden"}}>
        <div className='card-dev'>
<img src={imgDesign} alt='design' className='img-design img-fluid'   style={{
          width: "100%",
